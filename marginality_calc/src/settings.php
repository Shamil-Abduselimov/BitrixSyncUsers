<?php
// define('C_REST_CLIENT_ID','local.65054ed7a465f2.36310487');//Application ID
// define('C_REST_CLIENT_SECRET','wQ3NQkJhZqIcERTjZvG5Kb38ZSr1YlE4NE655Z7Bd9rBHXjGB0');//Application key
// or
